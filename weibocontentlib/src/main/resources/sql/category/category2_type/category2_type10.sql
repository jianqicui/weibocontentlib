...
create table category2_type10_user_collecting (
...
insert into category2_type10_user_collecting (user_id) values 
('1662379972'),
('1939419914'),
('2456439772'),
('2306414120'),
...
create table category2_type10_user_transfering (
	id int not null auto_increment,
  	cookies text not null,
